class ClientesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @cliente.save
        format.html { redirect_to(@cliente, :notice => 'El Cliente ha sido creado con éxito.') }
  ...
  def update
    ...
    respond_to do |format|
      if @cliente.update_attributes(params[:cliente])
        format.html { redirect_to(@cliente, :notice => 'El cliente ha sido actualizado con éxito.') }
        format.xml  { head :ok }
      else
